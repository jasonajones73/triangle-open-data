<template>
  <v-sheet>
    <v-parallax class="mx-13" src="chapelhill.jpeg" height="300"></v-parallax>
    <v-row>
      <v-card width="100%" class="mx-16">
        <v-card-title>Town of Chapel Hill Publishers</v-card-title>
        <v-tabs class="ma-auto">
          <v-tab
...
export default {
  ...
  data() {
    return {
      selectedValue: '',
      selectedTags: [],
      selectedPublisher: 'Town of Chapel Hill',
    }
  },
  computed: {
    ...mapState(['chapelCatalog']),
    publishers() {
      const pubs = []
